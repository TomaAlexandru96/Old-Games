...
public class MainOnlinePartner : MonoBehaviour {
	private int cooX;
	private int cooY;
		...
		for (i=1; i <= 8; i++) {
			for (j=1; j <= 8; j++) {
				if (a [i] [j] == 1) {
					...
					verify = GameObject.Find (i + " " + j);
					if (verify == null){
						clone = PhotonNetwork.Instantiate (pion, g.transform.position, g.transform.rotation, 0) as GameObject;
				...
				if (a [i] [j] == 2) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (tura, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//Debug.Log(clone.transform.name);
				}
				if (a [i] [j] == 3) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (cal, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//Debug.Log(clone.transform.name);
				}
				if (a [i] [j] == 4) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (nebun, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//Debug.Log(clone.transform.name);
				}
				if (a [i] [j] == 5) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (regina, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					//Debug.Log(clone.transform.name);
					clone.GetComponent<PhotonView>().viewID = 1;
				}
				if (a [i] [j] == 6) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (rege, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					//Debug.Log(clone.transform.name);
					clone.GetComponent<PhotonView>().viewID = 1;
				}
				...
				if (a [i] [j] == -1) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (pionN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					//	Debug.Log(clone.transform.name);
					clone.GetComponent<PhotonView>().viewID = 1;
				}
				if (a [i] [j] == -2) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (turaN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					//	Debug.Log(clone.transform.name);
					clone.GetComponent<PhotonView>().viewID = 1;
				}
				if (a [i] [j] == -3) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (calN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					//	Debug.Log(clone.transform.name);
					clone.GetComponent<PhotonView>().viewID = 1;
				}
				if (a [i] [j] == -4) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (nebunN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//Debug.Log(clone.transform.name);
				}
				if (a [i] [j] == -5) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (reginaN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//Debug.Log(clone.transform.name);
				}
				if (a [i] [j] == -6) {
					...
					formare = "p" + i.ToString () + j.ToString ();
					g = GameObject.Find (formare);
					clone = PhotonNetwork.Instantiate (regeN, g.transform.position, g.transform.rotation, 0) as GameObject;
					clone.transform.name = i + " " + j;
					clone.GetComponent<PhotonView>().viewID = 1;
					//	Debug.Log(clone.transform.name);
				}
				...
				if (moveP == 0) {
					if (player == 2) {
						if (piesaInlocuita == 2) {
							...
							clone = PhotonNetwork.Instantiate (tura, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 3) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (cal, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 4) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (nebun, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 5) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (regina, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 2) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (turaN, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 3) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (calN, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 4) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (nebunN, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
						...
						if (piesaInlocuita == 5) {
							formare = xP + " " + yP;
							Destroy (GameObject.Find (formare));
							clone = PhotonNetwork.Instantiate (reginaN, GameObject.Find ("p" + xP + yP).transform.position, GameObject.Find ("p" + xP + yP).transform.rotation, 0) as GameObject;
							clone.GetComponent<PhotonView>().viewID = 1;
							clone.name = formare;
							formare = "";
							alege = 0;
	...
	public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info){
		...
		if(stream.isWriting){
			...
			a = stream.ReceiveNext() as int[][];
			b = stream.ReceiveNext() as int[][];
